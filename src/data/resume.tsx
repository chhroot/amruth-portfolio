...
export const DATA = {
    ...
    description:
        'Developer & Designer / UX so smooth, even Gollum would say "precious" / Also Pine trees? Certified cool.',
    summary:
        'I design the UI 💖, write the logic, and sprinkle in the ✨. Fullstack developer with a soft spot for good UX and interfaces.I make websites so responsive, they text back 🙀! Yes I probably added that microinteraction you didn’t notice.',
    avatarUrl: '/me.jpg',
    skills: [
        'React',
        'React Native',
