                ...
                <section id="about">
                    ...
                    <BlurFade delay={BLUR_FADE_DELAY * 4}>
                        <p className="prose max-w-full text-pretty font-sans text-sm text-muted-foreground dark:prose-invert leading-normal">
                            ...
                            which basically means I’m obsessed with crafting
                            user experiences that feel as good as they look. My
                            sites are so responsive, they might just text you
                            back 🙀. That tiny microinteraction you didn’t
                            notice? Oh yeah… that was me 😉.
                        </p>
                    </BlurFade>
                </section>
                <section id="work">
                        ...
                        <BlurFade delay={BLUR_FADE_DELAY * 16}>
                            <div className="space-y-3">
                                ...
                                <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    ...
                                    Let&apos;s connect and brainstorm the next
                                    big thing over virtual coffee! ☕
                                </p>
                            </div>
                        </BlurFade>
                    </div>
